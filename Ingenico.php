...
//Auteur: Maarten Heylen: leerkracht

class Ingenico {

    private static $pspid = "2015ErasmusTest04";
    private static $shaKey = "ErasmusShaInHandtekening04";
...
class Betaling {
    ...
    public function genereerBetalingsformulier() {
        ...
        <?php } ?>
            ...
            <input type="submit" value="Proceed to Checkout" class="checkout-button button-add">
        </form> 
        <?php
    }
